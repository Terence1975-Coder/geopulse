...
def ensure_supabase_configured() -> None:
    """Raise if Supabase env vars are missing."""
...
def supabase_headers() -> Dict[str, str]:
    """Headers for service-role PostgREST access."""
...
async def fetch_workspace_settings(company_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
    params: Dict[str, str] = {
...
async def upsert_workspace_settings(
    ...
    existing = await fetch_workspace_settings(company_id)
